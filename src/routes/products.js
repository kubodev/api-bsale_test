...
router.get('/categoria/:id', (req, res) => {
  ...
  const sql = `SELECT p.id, p.name, p.url_image, p.price, p.discount, c.name as "categoriaNom"  FROM product p left join category c ON p.category = c.id WHERE p.category = '${id}'`;
